...
public class ErrorFind {
    public static void main(String[] args) {
        ...
        double theta = scanner.nextDouble(); // Fixed data type and variable name
        ...
        double A = P * Math.pow(1 + r / n, n * t); // Fixed method "Math.pow"
        ...
        double thetaPolar = Math.toDegrees(Math.atan2(y, x)); // Used atan2 for proper quadrant handling
